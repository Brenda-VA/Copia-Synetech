...
<template>
  ...
  >
    ...
    <div
      class="absolute z-10"
      :class="esTablet ? 'left-5 top-5' : 'left-5 top-5 md:left-6 md:top-6'"
    >
      <h3
  ...
  <article
    v-else
    class="relative overflow-hidden rounded-[2rem] bg-white shadow-[0_10px_25px_rgba(0,0,0,0.08)]"
    :class="esTablet
